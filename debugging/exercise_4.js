...
console.log(wantToVisit('NEMO Science Museum', 'Amsterdam') === true); // returns false
console.log(wantToVisit('National Museum of Modern Art', 'Paris') === false);
console.log(wantToVisit('Andy Warhol Museum of Modern Art', 'Medzilaborce') === true); // returns false
console.log(wantToVisit('Moco: Modern Contemporary Art', 'Amsterdam') === true); // returns false
